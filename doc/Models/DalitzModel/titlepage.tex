...
\begin{abstract}
  \noindent
  When an experiment publishes an amplitude model, it enivitably comes with it's own parametrisation of models describing the amplitude model.
  We attempt to document some parametrisations used by various experiments in $\decay{\Dz}{\KS\Kp\Km}$ models.
\end{abstract}
